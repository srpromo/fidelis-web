...
export function ProgressionRail({onNavigate,viewed,discoveryAvailable,discoveryComplete,washAvailable=false,washComplete=false,wash2Available=false,wash2Complete=false,wash3Available=false,wash3Complete=false,expressionAvailable=false,expressionComplete=false,resultAvailable=false}: {
 onNavigate:(stage:ViewedStage)=>void; viewed:ViewedStage; discoveryAvailable:boolean; discoveryComplete:boolean;washAvailable?:boolean;washComplete?:boolean;wash2Available?:boolean;wash2Complete?:boolean;wash3Available?:boolean;wash3Complete?:boolean;expressionAvailable?:boolean;expressionComplete?:boolean;resultAvailable?:boolean;
}) {
 const labels=['Thesis','Discovery','Wash 1','Wash 2','Wash 3','Expression','Result'];
 const available=[true,discoveryAvailable,washAvailable,wash2Available,wash3Available,expressionAvailable,resultAvailable];
 const completed=[true,discoveryComplete,washComplete,wash2Complete,wash3Complete,expressionComplete,resultAvailable];
 const current=resultAvailable?6:expressionAvailable?5:wash3Available?4:wash2Available?3:washAvailable?2:1;
