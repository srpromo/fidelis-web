...
export interface ResearchActivityEvent {id:string;type:DiscoveryEventType|Wash1EventType;origin:'LOCAL_DEMO'|'FIDELIS_SERVICE';message:string;sequence?:number;pathway?:DiscoveryPathway;candidate?:DiscoveryCandidate;ticker?:string}
